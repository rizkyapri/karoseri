                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="fs-lg fw-300">
                                        <p>
                                            Color, rather than shape, is more closely related to emotion. Each color has a
                                            strong blend and was selectively hand picked to make your design shine. Each
                                            component from SmartAdmin can have any of these colors applied. Try on different
                                            combinations to make your project come alive!
                                        </p>
                                        <p>
                                            SmartAdmin focuses on conveying the attention of your users to the important
                                            parts of the page and the actions. While keeping a light feel, the colors give
                                            the page an extra push.
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-hover table-clean">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-success"></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-warning"></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-danger"></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-info"></span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-primary"></span>
                                                    </td>
                                                    <td><code>*-primary</code></td>
                                                    <td><code>btn-primary</code> <code>color-primary</code>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="width-1 height-1 rounded-circle d-block bg-secondary"></span>
                                                    </td>
                                                    <td><code>*-secondary</code></td>
                                                    <td><code>btn-secondary</code> <code>color-secondary</code>
            ...
            <div class="col-md-12 col-xl-6">
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Success color pallet will be used for positive feedback and user assurance. We have selected
                                teal with a hint of green to stand out and cast the shadow of quality, healing, freshness
                                and peace
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-success-800"></span></td>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Warning color pallet lets users know to be catious and careful. It can envoke the feeling of
                                curiosity, confidence, sociability, and bravery
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-600"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-800"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-warning-900"></span></td>
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This color as an attention getter. Use this color as less as possible to have maximum
                                impact. This color is connected to ecitement, love, strength, and energy
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-danger-800"></span></td>
            ...
            <div class="col-md-12 col-xl-6">
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This particular pallet helps you build trust, it has the ability to project competence,
                                peace, loyalty and strength to your users
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-600"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-800"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-info-900"></span></td>
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                This is the primary color of the app, and is widely used in almost all of the elements. The
                                color shows ambition, sprituality, royalty and luxury
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-600"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-800"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-primary-900"></span></td>
                ...
                <div id="panel-7" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Fusion is a alternation of primary pallet. It is dramatic and bold. It has class and a sense
                                of formality combined with security.
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover table-clean">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-50"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-100"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-200"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-300"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-400"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-500"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-600"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-700"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-800"></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="height:20px; width:20px"
                                                    class="rounded-circle d-block bg-fusion-900"></span></td>
