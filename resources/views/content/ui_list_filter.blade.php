                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                To create a list filter, you will need to first create an <code>input</code> and an list,
                                assigning ID to each. For each list item you will add related filter tags separated by
                                spaces <code>data-filter-tags="*"</code> which will be used to filter out the list item.
                                Activate the filter tags by initlizing the script <code>initApp.listFilter($('list_id'),
                                    $('input_id'));</code>
                            </div>
                            <div id="js_default_list">
                                <div class="input-group mb-g">
                                    <input type="text" class="form-control form-control-lg shadow-inset-2"
                                        id="js_default_list_filter" placeholder="Filter list">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="border bg-light rounded-top">
                                <div class="form-group p-2 m-0 rounded-top">
                                    <input type="text" class="form-control form-control-lg shadow-inset-2 m-0"
                                        id="js_list_accordion_filter" placeholder="Filter accordion">
                                </div>
                                <div id="js_list_accordion" class="accordion accordion-hover accordion-clean">
                                    <div class="card border-top-left-radius-0 border-top-right-radius-0">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title" data-toggle="collapse"
                                                data-target="#js_list_accordion-a" aria-expanded="true"
                                                data-filter-tags="settings">
                                        ...
                                        <div id="js_list_accordion-a" class="collapse show"
                                            data-parent="#js_list_accordion">
                                            <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title collapsed"
                                                data-toggle="collapse" data-target="#js_list_accordion-b"
                                                aria-expanded="false" data-filter-tags="merge">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="javascript:void(0);" class="card-title collapsed"
                                                data-toggle="collapse" data-target="#js_list_accordion-c"
                                                aria-expanded="false" data-filter-tags="backup">
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                To add a response message for the filter input, you can add a container with the class
                                <code>.filter-message.js-filter-message</code> right after the list group
                            </div>
                            ...
                            <div class="bg-success-900 rounded bg-info-gradient">
                                <div class="d-flex position-relative py-3 px-4">
                                    ...
                                    <input type="text" id="js_nested_list_filter"
                                        ...
                                        placeholder="Filter nested items (e.g buttons, chart)">
                                </div>
                                <!-- nav-menu-reset will reset the font colors -->
                                <ul id="js_nested_list"
                                    class="nav-menu nav-menu-reset nav-menu-compact bg-success-900 bg-info-gradient mb-sm-4 mb-md-0 rounded"
                                    ...
                                    <li class="open active">
                                        ...
                                        <ul style="display:block;">
                                            ...
                                            <li>
                                                <a href="#"
                                                    data-filter-tags="user interface action dropdown navigation sidebars">
                                                    <span class="nav-link-text">
                                                        Action
                                                    </span>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#"
                                                            data-filter-tags="user interface action dropdown">
                                                            <span class="nav-link-text">
                                                                Dropdown
                                                            </span>
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            data-filter-tags="user interface action navigation">
                                                            <span class="nav-link-text">
                                                                Navigation
                                                            </span>
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            data-filter-tags="user interface action sidebars">
                                                            <span class="nav-link-text">
                                                                Sidebars
                                                            </span>
                                                        </a>
                                    ...
                                    <li>
                                        <a href="#"
                                            data-filter-tags="graphs flot chart pie sythentic graphs polygraphs">
                                            <span class="nav-link-text">
                                                Graphs
                                            </span>
                                    ...
                                    <li>
                                        <a href="#"
                                            data-filter-tags="forms controls loaders other elements buttons input checkbox">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#"
                                                    data-filter-tags="forms other elements buttons input checkbox">
                                                    <span class="nav-link-text">
                                                        Other elements
                                                    </span>
