                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Be sure to use an appropriate type attribute on all inputs (e.g., code <code>email</code>
                                for email address or <code>number</code> for numerical information) to take advantage of
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="example-email-2" name="example-email-2" class="form-control"
                                        placeholder="Email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" value="2023-07-23T11:25:00"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="example-range" type="range" name="range"
                                        min="0" max="100">
                                </div>
                                <div class="form-group">
            ...
            <div class="col-xl-6">
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add the disabled boolean attribute on an input to prevent user interactions and make it
                                appear lighter. By default, browsers will treat all native form controls
                                (<code>&lt;input&gt;</code>, <code>&lt;select&gt;</code> and <code>&lt;button&gt;</code>
                                elements) inside a <code>&lt;fieldset disabled&gt;</code> as disabled, preventing both
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-email-disabled">Email
                                        disabled</label>
                                    <input type="email" id="example-email-disabled" name="example-email-disabled"
                                        class="form-control" placeholder="Email" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-password-disabled">Password
                                        disabled</label>
                                    <input type="password" id="example-password-disabled" class="form-control"
                                        value="password" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-palaceholder-disabled">Placeholder
                                        disabled</label>
                                    <input type="text" id="example-palaceholder-disabled" class="form-control"
                                        placeholder="placeholder" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-textarea-disabled">Text area
                                        disabled</label>
                                    <textarea class="form-control" id="example-textarea-disabled" rows="5" disabled=""></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-static-disabled">Static control
                                        disabled</label>
                                    <input type="text" readonly="" class="form-control-plaintext"
                                        id="example-static-disabled" value="email@example.com" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-helping-disabled">Helping text
                                        disabled</label>
                                    <input type="text" id="example-helping-disabled" class="form-control"
                                        placeholder="Helping text" disabled="">
                                    <span class="help-block">
                                        A block of help text that breaks onto a new line and may extend beyond one line.
                                    </span>
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-select-disabled">Input Select
                                        disabled</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-multiselect-disabled">Multiple
                                        Select disabled</label>
                                    <select id="example-multiselect-disabled" multiple="" class="form-control"
                                        disabled="">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                ...
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-fileinput-disabled">Default file
                                        input disabled</label>
                                    <input type="file" id="example-fileinput-disabled" class="form-control-file"
                                        disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-datetime-local-input-disabled">Date
                                        and time disabled</label>
                                    <input class="form-control" type="datetime-local" value="2023-07-23T11:25:00"
                                        id="example-datetime-local-input-disabled" disabled="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-month-disabled">Month
                                        disabled</label>
                                    <input class="form-control" id="example-month-disabled" type="month"
                                        name="month" disabled="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-time-disabled-2">Time
                                        disabled</label>
                                    <input class="form-control" id="example-time-disabled-2" type="time"
                                        name="time" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-number">Number disabled</label>
                                    <input class="form-control" id="example-number-disabled" type="number"
                                        name="number" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-color">Color disabled</label>
                                    <input class="form-control" id="example-color-disabled" type="color"
                                        name="color" value="#ed1c24" disabled="">
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-muted" for="example-range-disabled">Range
                                        disabled</label>
                                    <input class="form-control" id="example-range-disabled" type="range"
                                        name="range" min="0" max="100" disabled="">
                                </div>
                                <div class="form-group">
            ...
            <div class="col-xl-12">
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Set heights using classes like <code>.input-lg</code>, <code>.input-sm</code> and for custom
                                inputs, you can use <code>.custom-select-sm</code>, <code>.custom-select-lg</code>, and set
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="utilities_responsive_grid.html" title="Responsive Grid"
                                                target="_blank">Check out how it works</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <input type="text" id="example-gridsize"
                                                class="form-control bg-primary-50" placeholder=".col-3">
                                        </div>
                                        <div class="col">
                                            <input type="text" id="example-gridsize-2"
                                                class="form-control bg-success-50" placeholder=".col">
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                <input class="form-control" id="gridrange" type="range"
                                                    name="gridrange" min="1" max="12" value="3">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="example-input-square"
                                            class="form-control form-control-lg rounded-0" placeholder="Square borders">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="example-input-pill" class="form-label">Rounded pill</label>
                                        <input type="text" id="example-input-pill"
                                            class="form-control form-control-lg rounded-pill" placeholder="Rounded pill">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="example-input-border"
                                            class="form-control form-control-lg border-info" placeholder="Border colors">
                                    </div>
                                </div>
                            </div>
                        </div>
