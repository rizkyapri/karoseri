                        ...
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>Place one add-on or button on either side of an input. You may also place one on both
                                    sides of an input. Remember to place <code>&lt;label&gt;</code>s outside the input
                                    group.</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="basic-addon2" type="text" class="form-control"
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input id="addon-wrapping-left" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group flex-nowrap">
                                    <input id="addon-wrapping-right" type="text" class="form-control"
                                        placeholder="Username" aria-label="Username"
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input id="input-group-lg-size" type="text" class="form-control"
                                        placeholder="Large size" aria-describedby="input-group-lg-size">
                                </div>
                                <span class="help-block">Some help content goes here</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input id="input-group-lg-size-2" type="text" class="form-control"
                                        placeholder="Large size" aria-describedby="input-group-lg-size-2">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="input-group-sm-size">Small Input Group</label>
                                <div class="input-group input-group-sm">
                                    <input id="input-group-sm-size" type="text" class="form-control"
                                        placeholder="Small size" aria-describedby="input-group-sm-size">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input id="input-group-sm-size-2" type="text" class="form-control"
                                        placeholder="Small size" aria-describedby="input-group-sm-size-2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" aria-label="Text input with checkbox"
                                        id="checkbox-group-4" placeholder="Record title">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <div class="custom-control d-flex custom-switch">
                                                <input id="eventlog-switch-1" type="checkbox"
                                                    class="custom-control-input">
                                                <label class="custom-control-label fw-500"
                                                    for="eventlog-switch-1">Debugger Active</label>
                                            </div>
                                        </div>
                                        <div class="input-group-text">
                                            <div class="custom-control d-flex custom-switch">
                                                <input id="eventlog-switch-2" type="checkbox"
                                                    class="custom-control-input">
                                                <label class="custom-control-label fw-500" for="eventlog-switch-2">Record
                                                    Logs</label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add the relative form sizing classes to the <code>.input-group</code> itself and contents
                                within will automatically resize—no need for repeating the form control size classes on each
                                element. You can add <code>.input-group-multi-transition</code> to <code>.input-group</code>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-multi-transition">
                                    ...
                                    <input type="text" class="form-control"
                                        aria-label="Dollar amount (with dot and two decimal places)" id="dollar-1"
                                        placeholder="Recipient">
                                    <input type="text" class="form-control" aria-label="Person name"
                                        placeholder="Email">
                                    <input type="text" class="form-control" aria-label="Person name"
                                        placeholder="Amount">
                                    <div class="input-group-append">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <button type="button"
                                            class="btn btn-outline-default dropdown-toggle dropdown-toggle-split"
                                    ...
                                    <input type="text" class="form-control"
                                        aria-label="Text input with segmented dropdown button" id="drop-w-action-left">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                        aria-label="Text input with segmented dropdown button" id="drop-w-action-right">
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-outline-default">Action</button>
                                        <button type="button"
                                            class="btn btn-outline-default dropdown-toggle dropdown-toggle-split"
            ...
            <div class="col-xl-6">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm bg-white shadow-inset-2">
                                    <div class="input-group-prepend">
                                        <span
                                            class="input-group-text bg-transparent border-right-0 py-1 px-3 text-success">
                                            <i class="fal fa-search"></i>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control border-left-0 bg-transparent pl-0"
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-default" type="button" id="button-addon2">Look
                                            up!</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="button-addon4" type="text" class="form-control"
                                        placeholder="Search anything..." aria-label="Example text with button addon"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Recipient's username"
                                        aria-label="Recipient's username" aria-describedby="button-addon5">
                                    <div class="input-group-append">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                        aria-label="Text input with dropdown button" id="dropdown-on-left">
                                </div>
                                <span class="help-block">Some help content goes here</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                        aria-label="Text input with dropdown button" id="dropdown-on-right">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-default dropdown-toggle" type="button"
                                            data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">Dropdown</button>
                ...
                <div id="panel-10" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Input groups include support for custom selects and custom file inputs. Browser default
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <button type="button"
                                            class="btn btn-success shadow-0 dropdown-toggle dropdown-toggle-split"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="sr-only">Toggle Dropdown</span>
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-right">
