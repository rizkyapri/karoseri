            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <br>Progress components are built with two HTML elements, some CSS to set the width, and a few
                        attributes. We don’t use <a
                            href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/progress" target="_blank">the
                            HTML5 <code>&lt;progress&gt;</code> element</a>, ensuring you can stack progress bars, animate
            ...
            <div class="col-xl-6">
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                The <code>.progress</code> is a wrapper to indicate the max value of the progress bar. We
                                use the inner <code>.progress-bar</code> to indicate the progress so far. The
                                <code>.progress-bar</code> requires an inline style, utility class, or custom CSS to set
                                their width. You can add some role and aria attributes to make it accessible.
                            </div>
                            <div class="progress">
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Control the height by adding style <code>height:"value"</code> to <code>.progress</code>
                                element or you could use the prebuilt classes for a more uniform structure,
                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Control the background by adding avaialble <a href="utilities_color_pallet.html"
                                    target="_blank">color pallets</a> to <code>.progress</code> class
                            </div>
                            <div class="demo-v-spacing">
                                <div class="progress">
                ...
                <div id="panel-4" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: 10%" aria-valuenow="15"
                                    aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="demo-v-spacing">
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-success-700 bg-primary-gradient" role="progressbar"
                                ...
                                <div class="progress">
                                    <div class="progress-bar bg-success-500 bg-danger-gradient" role="progressbar"
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="demo js-progress-animated">
                                <div class="progress progress-xl">
                                    <div class="progress-bar progress-bar-striped bg-primary-500" role="progressbar"
                                        style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                            <button type="button" class="btn btn-secondary" data-toggle="button" aria-pressed="false"
                                data-action="toggle" data-class="progress-bar-animated"
                                data-target=".js-progress-animated .progress-bar">
                                Toggle animation
                            </button>
                        </div>
                    </div>
