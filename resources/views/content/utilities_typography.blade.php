            ...
            <div class="col-lg-12 col-xl-6">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                When you need a heading to stand out, consider using a display heading—a larger, slightly
                        ...
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                <code>&lt;blockquote class="blockquote"&gt;</code> around any <abbr
                                    title="HyperText Markup Language">HTML</abbr> as the quote. Add a <code>&lt;footer
                                    class="blockquote-footer"&gt;</code> for identifying the source. Wrap the name of the
                                source work in <code>&lt;cite&gt;</code>
                            </div>
                ...
                <div id="panel-8" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Wrap text with a <code>.text-wrap</code> class, to prevent text from wrapping with a
                ...
                <div id="panel-9" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                For longer content, you can add a <code>.text-truncate</code> class to truncate the text
                                with an ellipsis. <span class="fw-400">Requires</span> <code>display: inline-block</code>
                                or <code>display: block</code>. You can also combine the following classe
                                <code>.text-truncate</code> and combine with <code>.text-truncate-xs</code>,
                                <code>.text-truncate-sm</code>, <code>.text-truncate-md</code>,
                                <code>.text-truncate-default</code>, and <code>.text-truncate-lg</code> to achieve the
                                desired results
                            </div>
                            <div class="frame-wrap">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                <code>.text-{left,right,center,justify}</code>
                            </div>
            ...
            <div class="col-lg-12 col-xl-6">
                ...
                <div id="panel-11" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Quickly change the weight (boldness) of text with <code>.font-weight-bold</code> or
                                italicize text with <code>.font-italic</code>. Reset boldness of text with
                                <code>.font-weight-bold</code>. Try various font weights using
                                <code>.fw-{300,400,500,700,900}</code>
                            </div>
                            <div class="frame-wrap">
                                <div class="demo-v-spacing">
                                    ...
                                    <p class="m-0"><span class="fw-900"><u>Sample boldest &amp; underline
                                                text</u></span></p>
                            ...
                            <div class="frame-wrap">
                                <div class="demo-v-spacing">
                                    ...
                                    <p><span class="fw-900 text-uppercase font-italic">Boldest text with uppercase & italic
                                            font</span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                styling links with hover states, too. Reset colors using <code>.text-reset</code> class.
                            </div>
                            <div class="demo-v-spacing">
                ...
                <div id="panel-14" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Basic links example with font weight variations and colors. Active links on left, inactive
                                on right
                            </div>
                            <div class="frame-wrap">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="demo-v-spacing">
                                            ...
                                            <p><a href="#"><span class="fw-300 font-italic">Sample light &amp;
                                                        italic text</span></a></p>
                                            <p class="m-0"><a href="#"><span class="fw-900"><u>Sample boldest
                                                            &amp; underline text</u></span></a></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="demo-v-spacing">
                                            <p><a href="#" class="disabled"><span>Sample text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-300">Sample light
                                                        text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-500">Sample bold
                                                        text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-700">Sample bolder
                                                        text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-900">Sample boldest
                                                        text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-300 font-italic">Sample
                                                        light &amp; italic text</span></a></p>
                                            <p><a href="#" class="disabled"><span class="fw-900"><u>Sample boldest
                                                            &amp; underline text</u></span></a></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                only). <span class="fw-400">This only applies to immediate children list items</span>,
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code>
