                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add <code>.custom-control</code> and <code>.custom-checkbox</code> wrapper to your
                                <code>input</code> and <code>label</code> to create a custom checkbox component. You can add
                                <code>.custom-checkbox-circle</code> to change it to a circular checkbox
                            </div>
                            <button id="js-checkbox-toggle" data-toggle="button" class="btn btn-outline-danger mb-g"
                                onclick="toggleCheckbox();">Change to CIRCLE</button>
                                ...
                                <div class="demo">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="defaultUncheckedDisabled"
                                            disabled="">
                                        <label class="custom-control-label" for="defaultUncheckedDisabled">Unchecked &
                                            disabled</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="defaultCheckedDisabled"
                                            checked="" disabled="">
                                        <label class="custom-control-label" for="defaultCheckedDisabled">Checked &
                                            disabled</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                <code>input</code> and <code>label</code> to create a custom radio component. You can add
                                <code>.custom-radio-rounded</code> to change it to a rounded radio
                            </div>
                            <button id="js-radio-toggle" data-toggle="button" class="btn btn-outline-danger mb-g"
                                onclick="toggleRadio();">Change to ROUNDED</button>
                            <h5 class="frame-heading">Block alignment</h5>
                            <div class="frame-wrap">
                                <div class="demo">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input active"
                                            id="defaultUncheckedRadio2" name="defaultExampleRadios">
                                        <label class="custom-control-label" for="defaultUncheckedRadio2">Unchecked</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input"
                                            id="defaultUncheckedDisabledRadio2" name="defaultExampleRadios1"
                                            disabled="">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input"
                                            id="defaultCheckedDisabledRadio2" name="defaultCheckedDisabledRadio2"
                                            checked="" disabled="">
                                        <label class="custom-control-label" for="defaultCheckedDisabledRadio2">Checked &
                                            disabled</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="frame-wrap">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="defaultInline4Radio"
                                        name="inlineDefaultRadiosExample2" disabled="">
                                    <label class="custom-control-label" for="defaultInline4Radio">Disabled</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="defaultInline3Radio"
                                        name="inlineDefaultRadiosExample2" checked="" disabled="">
                                    <label class="custom-control-label" for="defaultInline3Radio">Checked &
                                        disabled</label>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="demo">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch3"
                                                    checked="" disabled="">
                                                <label class="custom-control-label" for="customSwitch3">Checked &
                                                    disabled</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="frame-wrap demo">
                                        <div class="demo">
                                            <div class="custom-control custom-switch">
                                                <input type="radio" class="custom-control-input"
                                                    id="customSwitch1radio" name="defaultSwitchRadioExample">
                                                <label class="custom-control-label"
                                                    for="customSwitch1radio">Unchecked</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="radio" class="custom-control-input"
                                                    id="customSwitch2radio" checked=""
                                                    name="defaultSwitchRadioExample">
                                                <label class="custom-control-label"
                                                    for="customSwitch2radio">Checked</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="radio" class="custom-control-input" disabled
                                                    id="customSwitchdradio" name="defaultSwitchRadioExample2">
                                                <label class="custom-control-label"
                                                    for="customSwitchdradio">Disabled</label>
                                            </div>
                                            <div class="custom-control custom-switch">
                                                <input type="radio" class="custom-control-input"
                                                    id="customSwitch3radio" checked="" disabled=""
                                                    name="defaultSwitchRadioExample2">
                                                <label class="custom-control-label" for="customSwitch3radio">Checked &
                                                    disabled</label>
                                            </div>
                                        </div>
                                    </div>
