            ...
            <div class="col">
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        jQuery UI is a widget and interaction library built on top of the jQuery JavaScript Library that you
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        Using jQuery throttle / debounce, you can pass a delay and function to $.debounce to get a new
                        function, that when called repetitively, executes the original function just once per “bunch” of
                        calls, effectively coalescing multiple sequential calls into a single execution at either the
                        beginning or end.
                    </div>
                </div>
                <div class="card mb-g">
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        The entire app core, has a lot of useful functions, including saving/loading, mapping objects, data
                        management, DOM cycles, page hight calculations, and many more.
                    </div>
                </div>
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        A small JavaScript library which allows you to create programmatic dialog boxes using Bootstrap
                        modals, without having to worry about creating, managing, or removing any of the required DOM
                        elements or JavaScript event handlers.
                    </div>
                </div>
                <div class="card mb-g">
                    <div class="card-body">
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        slimScroll is a small jQuery plugin that transforms any div into a scrollable area. slimScroll
                ...
                <div class="card mb-g">
                    <div class="card-body">
                        ...
                        Transforms your panel component into draggable, localstorage based component. Remembering position,
                        collapse state, and color changes.
                    </div>
                </div>
                <div class="card mb-g">
                    <div class="card-body">
