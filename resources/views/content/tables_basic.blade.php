            ...
            <div class="col-lg-12 col-xl-6">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                SmartAdmin. You can inverse a table by using the class <code>.table-dark</code>
                            </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                ...
                                <code>&lt;thead&gt;</code>s appear custom, dark gray, white and themed.
                            </div>
                            <h5 class="frame-heading">
                                Inverse
                            </h5>
                            ...
                            <h5 class="frame-heading">
                                Custom <a href="utilities_color_pallet.html" title="Color Pallets"><i
                                        class="fal fa-reply"></i> </a>
                            </h5>
                            <div class="frame-wrap">
                                <table class="table m-0">
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add <code>.table-striped</code> to add zebra-striping to any table, and add
                                <code>.table-dark</code> for inverse pattern
                            </div>
                            <h5 class="frame-heading">
                                Pattern
                            </h5>
            ...
            <div class="col-lg-12 col-xl-6">
                ...
                <div id="panel-6" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Use contextual classes to color table rows or individual cells. See the full list of <a
                                    href="utilities_color_pallet.html" title="Color Pallets" target="_blank">color
                                    selection</a>
                            </div>
                            <table class="table m-0">
                                <thead>
                ...
                <div id="panel-7" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Add <code> .table-sm</code> to make tables more compact by cutting cell padding in half. See
                                the full list of <a href="utilities_color_pallet.html" title="Color Pallets">color
                                    selection</a> to add backgrounds as well
                            </div>
                            <h5 class="frame-heading">
                                Compact
                            </h5>
                ...
                <div id="panel-8" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Make table responsive with <code>.table-responsive</code>. Maximum breakpoint can be applied
                                by adding <code>.table-responsive-sm</code>, <code>.table-responsive-ms</code>,
                                <code>.table-responsive-lg</code>, <code>.table-responsive-xl</code>
                            </div>
