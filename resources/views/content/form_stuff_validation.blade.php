                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>Validation styles are available for the following form controls and components:
                            <code>&lt;input&gt;</code> and <code>&lt;textarea&gt;</code> with <code>.form-control</code>
                            (including up to one <code>.form-control</code> in input groups), <code>&lt;select&gt;</code>
                            with <code>.form-select</code> or <code>.custom-select</code>, <code>.form-check</code>,
                            <code>.custom-checkbox</code> and <code>.custom-radio</code>, <code>.custom-file</code>
                        </p>
                        Learn more about forms on bootstrap's <a
                            href="https://getbootstrap.com/docs/4.5/components/forms/#how-it-works" target="_blank">official
                            documentation</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6">
                        ...
                        <div class="panel-content">
                            <form class="was-validated">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control is-invalid" id="validationTextarea3" placeholder="Required example textarea" required
                                        rows="4"></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a message in the textarea.
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="customControlValidation4">Toggle this
                                ...
                                <div class="form-group">
                                    <label class="form-label is-invalid" for="customControlValidation6">Multiple
                                        Select</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customControlValidation7"
                                            required>
                                        <label class="custom-file-label" for="customControlValidation7">Choose
                                            file...</label>
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                <p>For custom Bootstrap form validation messages, you’ll need to add the
                                    <code>novalidate</code> boolean attribute to your <code>&lt;form&gt;</code>. This
                                    ...
                                    intercept the submit button and relay feedback to you. When attempting to submit, you’ll
                                    see the <code>:invalid</code> and <code>:valid</code> styles applied to your form
                                    controls.
                                </p>
                                <p>Custom feedback styles apply custom colors, borders, focus styles, and background icons
                                    to better communicate feedback. Background icons for <code>&lt;select&gt;</code>s are
                                    only available with <code>.custom-select</code>, and not <code>.form-control</code>.</p>
                            </div>
                        </div>
                                ...
                                <div class="panel-content">
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom01"
                                                placeholder="First name" value="Codex" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="validationCustom02">Last name <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="validationCustom02"
                                                placeholder="Last name" value="Lantern" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="validationCustomUsername">Username <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="form-row form-group">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="validationCustom03">City <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label" for="validationCustom03">State <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label" for="validationCustom05">Zip <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label class="form-label" for="validationTextarea2">Comment <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <label class="form-label mb-2">Please disclose your gender profile <span
                                                    class="text-danger">*</span></label>
                                            <div class="custom-control custom-radio mb-2">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="genderPrivate"
                                                    name="radio-stacked" required="">
                                                <label class="custom-control-label" for="genderPrivate">Prefer not to
                                                    say</label>
                        ...
                        <div class="panel-content">
                            <form class="was-validated">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-valid" id="simpleinputInvalid2" required
                                        value="test">
                                    <div class="valid-feedback">
                                        Please enter a message in the textarea.
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control is-valid" id="validationTextarea" placeholder="Required example textarea" required
                                        rows="4">test</textarea>
                                    <div class="valid-feedback">
                                        Please enter a message in the textarea.
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" class="custom-control-input"
                                            id="customControlValidationSuccess1" required checked="">
                                        <label class="custom-control-label" for="customControlValidationSuccess1">Check
                                            this custom checkbox</label>
                                        <div class="valid-feedback">Example valid feedback text</div>
                                    </div>
                                    <div class="custom-control custom-radio mb-2">
                                        <input type="radio" class="custom-control-input"
                                            id="customControlValidationSuccess2" name="radio-stacked" required
                                            checked="">
                                        <label class="custom-control-label" for="customControlValidationSuccess2">Toggle
                                            this custom radio</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input"
                                            id="customControlValidationSuccess3" name="radio-stacked" required>
                                        <label class="custom-control-label" for="customControlValidationSuccess3">Or
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input is-valid"
                                            id="customControlValidationSuccess4" required checked="">
                                        <label class="custom-control-label" for="customControlValidationSuccess4">Toggle
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="customControlValidationSuccess6">Multiple
                                        Select</label>
                                    <select id="customControlValidationSuccess6" multiple=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input is-valid"
                                            id="customControlValidationSuccess7">
                                        <label class="custom-file-label" for="customControlValidationSuccess7">Choose
                                            file...</label>
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="panel-content">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="validationTooltip03">Username <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="form-row form-group">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label" for="validationTooltip05">State <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label" for="validationTooltip06">Zip <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label class="form-label" for="validationTooltip07">Comment <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="custom-control custom-radio mb-2">
                                                <input type="radio" class="custom-control-input"
                                                    id="validationTooltipGenderMale" name="radio-stacked" required="">
                                                <label class="custom-control-label"
                                                    for="validationTooltipGenderMale">Male</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-2">
                                                <input type="radio" class="custom-control-input"
                                                    id="validationTooltipGenderFemale" name="radio-stacked"
                                                    required="">
                                                <label class="custom-control-label"
                                                    for="validationTooltipGenderFemale">Female</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input"
                                                    id="validationTooltipgenderPrivate" name="radio-stacked"
                                                    required="">
                                                <label class="custom-control-label"
                                                    for="validationTooltipgenderPrivate">Prefer not to say</label>
                                ...
                                <div
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="validationTooltipAgreement" required>
                                        <label class="custom-control-label" for="validationTooltipAgreement">Agree to
                                            terms and conditions <span class="text-danger">*</span></label>
                                        <div class="invalid-tooltip">
                                            You must agree before submitting.
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="validationDefaultUsername"
                                                    placeholder="Username" aria-describedby="inputGroupPrepend4" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="invalidCheck2"
                                                required="">
                                            <label class="custom-control-label" for="invalidCheck2">Agree to terms and
                                                conditions</label>
                                        </div>
                                    </div>
                                </div>
